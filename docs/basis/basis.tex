...
The paper is organized as follows. In Section~\ref{sec-design} we describe the design of \basis{} in detail. Section~\ref{sec-impl} provides implementation details. Section~\ref{sec-security} analyzes its security properties. In Section~\ref{sec-adv} we provide analysis of advantages and drawbacks of the protocol.
