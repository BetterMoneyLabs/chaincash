...
The following options exist to improve the tracker service:
...
To avoid reserve owner censorship, the reserve contract has a refund option, which allows the reserve owner to withdraw funds without a tracker after a long enough time.
