...
We demonstrate two example applications: group trading over a local mesh network with occasional Internet connection, where notes circulate off-chain and synchronize when connectivity is available; and AI agent economies where autonomous agents create credit relationships for services rendered.
