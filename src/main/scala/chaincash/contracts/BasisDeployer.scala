...
import org.ergoplatform.restapi.client.{Asset, ErgoTransactionOutput, RegisterValue}
import scorex.crypto.encode.Base16
import scorex.util.encode.Base64
import sigmastate.Values.{BooleanConstant, GroupElementConstant, IntConstant, LongConstant}
...
object BasisDeployer extends App {
   ...
   */
  val exampleOwnerKey: GroupElementConstant = createOwnerKeyFromHex(
    "025ffe0e1a282fc0249320946af4209eb2dd7f250c16946fdd615533092e054bca"
  )
  ...
  def createBasisDeploymentRequest(
    ...
    val emptyTreeEncoded = Base16.encode(ValueSerializer.serialize(emptyTree))
  ...
  def main(args: Array[String]): Unit = {
    ...
    val exampleOwnerKey = KeyUtils.exampleOwnerKey // Using the specified example owner key
